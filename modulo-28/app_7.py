...
def main():
    ...
    st.set_page_config(page_title = 'Telemarketing analisys', \
        page_icon = 'https://github.com/jeffersonsilva11/Cientista-de-Dados/blob/main/modulo-28/telmarketing_icon.png',
        layout="wide",
    ...
    image = Image.open("https://github.com/jeffersonsilva11/Cientista-de-Dados/blob/main/modulo-28/Bank-Branding.jpg")
